	...
	return(
		<div className="app__featured">
			...
			<div className="app__featuredRating">
				<Rating name="movie-rating" value={(featuredMovie.vote_average / 2) || 0} precision={0.5} icon={<StarRoundedIcon fontSize="inherit" readOnly />}/>
				<p className="app__featuredLikes">{(featuredMovie.vote_average / 2) || 0}<small> ({featuredMovie.vote_count || 0})</small></p>
			</div>
